                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div className="text-left">
                        <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-gray-900 tracking-tight mb-6 leading-tight">
                            ACCELERATE YOUR <br />
                            <span className="text-blue-600">MARKET REACH</span>
                        </h1>
                        <p className="mt-6 max-w-lg text-xl text-gray-600 mb-10 leading-relaxed">
                            We empower your brand with scalable software and targeted marketing strategies to capture new opportunities fast.
                        </p>
